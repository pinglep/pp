...
<body>
	...
	<table border="1" cellpadding="5" cellspacing="5">
		<tr>
			...
			<td><b>DETAILS</b></td>
			<td><b>POSTED BY</b></td>
			<td><b>POSTED IMAGE</b></td>
			<td><b>TAKE ACTION</b></td>
		</tr>
		<c:forEach var="adv" items="${adverts}">
			<tr>
				<td style="text-align: top">${adv.title}</td>
				<td>${adv.message}</td>
				<td>${adv.user.username}</td>
				<td><img src="${adv.imgSrc}" style="height:50px; vertical-align: top"></img></td>
				<td><a href = "${contextPath}/advert/update?id=${adv.title}">Update Details</</a></td>
